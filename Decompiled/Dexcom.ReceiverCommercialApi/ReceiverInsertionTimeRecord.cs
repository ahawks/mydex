// Type: Dexcom.ReceiverApi.ReceiverInsertionTimeRecord
...
namespace Dexcom.ReceiverApi
{
  ...
  public struct ReceiverInsertionTimeRecord : IGenericReceiverRecord
  {
    public uint SystemSeconds;
    public uint DisplaySeconds;
    public uint InsertionTimeinSeconds;
    ...
    public DateTime InsertionTimeStamp
    {
      get
      {
        return ReceiverTools.ConvertReceiverTimeToDateTime(this.InsertionTimeinSeconds);
      }
    }
  }
}
