// Type: Dexcom.ReceiverApi.SensorSessionState
...
{
  public enum SensorSessionState : byte
  {
    None,
    SensorRemoved,
    SessionExpired,
    ResidualAberration,
    CountsAberration,
    TryingToStartSecondSession,
    SensorShutOffDueToTimeLoss,
    SessionStarted,
    BadTransmitter,
    EnteringManufacturingMode,
  }
}
