// Type: Dexcom.R2Receiver.R2STSCalibration4Record
...
namespace Dexcom.R2Receiver
{
  ...
  public struct R2STSCalibration4Record : IGenericR2Record
  {
    ...
    public byte m_severeResidualAberrantPoints;
    public byte m_severeEgvAberrantPoints;
    public byte m_pointsToGetInCal;
    public ushort m_sensorLife;
    public byte m_severeDeltaResidualPoints;
    public byte m_isNoisePeriod;
    ...
    public R2RecordType RecordType
    {
      get
      {
        return R2RecordType.STS_Calibration4;
      }
    }
