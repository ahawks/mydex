// Type: Dexcom.R2Receiver.R2HWConfigV5
...
namespace Dexcom.R2Receiver
{
  ...
  public struct R2HWConfigV5
  {
    ...
    public void UpdateCrc()
    {
      ...
      Trace.Assert(buf.Length == 1024, "R2HWConfigV5 structure is not defined with correct size of 1024 bytes!");
      int start = 0;
