// Type: Dexcom.R2Receiver.R2STSCalibration5Record
...
namespace Dexcom.R2Receiver
{
  ...
  public struct R2STSCalibration5Record : IGenericR2Record
  {
    public R2RecordHeader m_header;
    public R2DatabaseKey m_key;
    public byte m_countsAberrantPoints;
    public byte m_absoluteAberrantPoints;
    public byte m_powerAberrantPoints;
    public byte m_algorithmCalibrationState;
    public byte m_calSetPoints;
    public R2MatchedPairData m_calibrationSet0;
    public R2MatchedPairData m_calibrationSet1;
    public R2MatchedPairData m_calibrationSet2;
    public R2MatchedPairData m_calibrationSet3;
    public R2MatchedPairData m_calibrationSet4;
    public R2MatchedPairData m_calibrationSet5;
    ...
    public R2RecordType RecordType
    {
      get
      {
        return R2RecordType.STS_Calibration5;
      }
    }
