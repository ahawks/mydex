// Type: Dexcom.R2Receiver.R2HWConfigV7
...
namespace Dexcom.R2Receiver
{
  ...
  public struct R2HWConfigV7
  {
    ...
    public double m_alphaLight;
    public double m_alphaMedium;
    public double m_alphaSevere;
    public double m_alphaSignal;
    public double m_thresholdLight;
    public double m_thresholdMedium;
    public double m_thresholdSevere;
    [MarshalAs(UnmanagedType.ByValArray, SizeConst = 672)]
    ...
    public void UpdateCrc()
    {
      ...
      Trace.Assert(buf.Length == 1024, "R2HWConfigV7 structure is not defined with correct size of 1024 bytes!");
      int start = 0;
